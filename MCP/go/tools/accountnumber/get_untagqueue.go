...
func Get_untagqueueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/%s/%s/#Action=UntagQueue%s", cfg.BaseURL, AccountNumber, QueueName, queryString)
...
func CreateGet_untagqueueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_AccountNumber_QueueName_#Action=UntagQueue",
		mcp.WithDescription("<p>Remove cost allocation tags from the specified Amazon SQS queue. For an overview, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-queue-tags.html">Tagging Your Amazon SQS Queues</a> in the <i>Amazon SQS Developer Guide</i>.</p> <note> <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a username</a> in the <i>Amazon SQS Developer Guide</i>.</p> </note>"),
		mcp.WithArray("TagKeys", mcp.Required(), mcp.Description("The list of tags to be removed from the specified queue.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_untagqueueHandler(cfg),
	}
}
